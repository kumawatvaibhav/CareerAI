...
import { Mail, Lock, Eye, EyeOff, Loader2, Home, Menu, Bell, User, Search } from "lucide-react";
      ...
      <div className="w-full lg:w-1/2 flex flex-col bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          ...
          >
            ...
            >
              <p className="text-sm text-gray-500 mb-3">Trusted by leading organizations</p>
              <div className="flex justify-center space-x-6 opacity-60">
                {["Google", "Microsoft", "Amazon", "IBM"].map((company) => (
